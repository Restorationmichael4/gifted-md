...
global.footer = "*ᴘᴏᴡᴇʀᴇᴅ ʙʏ Titan Tech*"; // Input Yours custom...(Maintain font for Flow)
...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~8CkCDaTY#j2jQbf_7rz_qinAHom9gH477mVCk02W-7nb0zrLoWQY", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
AUTO_BIO_QUOTE: process.env.AUTO_BIO_QUOTE || "Titan is the greatest",
